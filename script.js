...
function getExample(word, language) {
    const examples = {
        tr: { text: `“${word.tr}” kelimesini öğreniyoruz.`, ja: `私たちは「${word.ja}」という単語を学んでいます。` },
        ar: { text: `نتعلم كلمة «${word.ar}».`, latn: `nataʿallamu kalimata «${word.arLatn}».`, ja: `私たちは「${word.ja}」という単語を学んでいます。` },
        fa: { text: `ما واژهٔ «${word.fa}» را یاد می‌گیریم.`, latn: `mâ vâže-ye «${word.faLatn}» râ yâd migirim.`, ja: `私たちは「${word.ja}」という単語を学んでいます。` },
        mn: { text: `Бид «${word.mn}» гэдэг үгийг сурч байна.`, ja: `私たちは「${word.ja}」という単語を学んでいます。` },
        hi: { text: `हम “${word.hi}” शब्द सीख रहे हैं।`, latn: `ham “${word.hiLatn}” shabd sīkh rahe haĩ.`, ja: `私たちは「${word.ja}」という単語を学んでいます。` }
    };
    return examples[language.key];
}
