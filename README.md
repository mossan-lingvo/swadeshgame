...
5言語から任意の2言語を選び、第1言語、第2言語の順番で同じ単語を確認できます。モンゴル語には標準ハルハ方言のIPAを、アラビア語・ペルシア語・ヒンディー語にはラテン文字転写を表示します。解答後には、単語の意味に応じた簡単な例文と日本語訳を表示します。10語を1セットとして、正解済みの単語を除外しながら全語に正解するまで復習し、終了時に正答率を表示します。
